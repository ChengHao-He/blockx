...
function functionBlocks(Blockly) {
  ...
  [
    ...
    Blockly.Python['Function' + parameterType] = function(block) {
      const name =
      Blockly.Python.variableDB_.getName(block.getFieldValue('NAME'),
   ...
   */
    domToMutation: function(xmlElement) {
      this.decoratorsCount_ =
      parseInt(xmlElement.getAttribute('decorators'), 10);
      this.parametersCount_ =
      parseInt(xmlElement.getAttribute('parameters'), 10);
