...
const toolBoxList = {
  'Variables':'',
  'Decisions':
  '<block type="ast_If" line_number="1"><mutation orelse="false" elifs="0"></mutation></block>'+
  '<block type="ast_If" line_number="1"><mutation orelse="true" elifs="0"></mutation></block>'+
  '<block type="ast_Compare" line_number="1" inline="true"><field name="OP">Lt</field></block>'+
  '<block type="ast_BoolOp" line_number="1" inline="true"><field name="OP">And</field></block>'+
  '<block type="ast_UnaryOpNot" line_number="1" inline="false"></block>',
  'Iteration':
  '<block type="ast_For" line_number="1"></block>',
  'Calculation':
  '<block type="ast_BinOp" line_number="1" inline="true"><field name="OP">Add</field></block>'+
  '<block type="ast_Call" line_number="1" inline="true"><mutation arguments="1" returns="true" parameters="true" method="false" name="round" message="round" premessage="" colour="190" module=""><arg name="UNKNOWN_ARG:0"></arg></mutation></block>',
  'Output':
  '<block type="ast_Call" line_number="1" inline="true"><mutation arguments="1" returns="false" parameters="true" method="false" name="print" message="print" premessage="" colour="170" module=""><arg name="UNKNOWN_ARG:0"></arg></mutation></block>',
   'Input':
   '<block type="ast_Call" line_number="1" inline="true"><mutation arguments="1" returns="true" parameters="true" method="false" name="input" message="input" premessage="" colour="170" module=""><arg name="UNKNOWN_ARG:0"></arg></mutation><value name="ARG0"><block type="ast_Str" line_number="1"><field name="TEXT"></field></block></value></block>',
  'Values':
  '<block type="ast_Str" line_number="1"><field name="TEXT"></field></block>'+
  '<block type="ast_Num" line_number="1"><field name="NUM">0</field></block>'+
  '<block type="ast_NameConstantBoolean" line_number="1"><field name="BOOL">TRUE</field></block>',
  'Conversion':
  '<block type="ast_Call" line_number="1" inline="true"><mutation arguments="1" returns="true" parameters="true" method="false" name="int" message="int" premessage="" colour="190" module=""><arg name="UNKNOWN_ARG:0"></arg></mutation></block>'+
  '<block type="ast_Call" line_number="1" inline="true"><mutation arguments="1" returns="true" parameters="true" method="false" name="float" message="float" premessage="" colour="190" module=""><arg name="UNKNOWN_ARG:0"></arg></mutation></block>'+
  '<block type="ast_Call" line_number="1" inline="true"><mutation arguments="1" returns="true" parameters="true" method="false" name="str" message="str" premessage="" colour="120" module=""><arg name="UNKNOWN_ARG:0"></arg></mutation></block>'+
  '<block type="ast_Call" line_number="1" inline="true"><mutation arguments="1" returns="true" parameters="true" method="false" name="bool" message="bool" premessage="" colour="345" module=""><arg name="UNKNOWN_ARG:0"></arg></mutation></block>',
  'Lists':
  '<block type="ast_List" line_number="1" inline="true"><mutation items="3"></mutation><value name="ADD0"><block type="ast_Num" line_number="1"><field name="NUM">0</field></block></value><value name="ADD1"><block type="ast_Num" line_number="1"><field name="NUM">0</field></block></value><value name="ADD2"><block type="ast_Num" line_number="1"><field name="NUM">0</field></block></value></block>'+
  '<block type="ast_List" line_number="1" inline="true"><mutation items="3"></mutation></block>'+
  '<block type="ast_List" line_number="1" inline="true"><mutation items="0"></mutation></block>'+
  '<block type="ast_MyBreak" line_number="1" inline="true"><mutation items="0"></mutation></block>'+
  '<block type="ast_Call" line_number="1" inline="true"><mutation arguments="1" returns="false" parameters="true" method="true" name=".append" message="append" premessage="to list" colour="30" module=""><arg name="UNKNOWN_ARG:0"></arg></mutation></block>',
}
function BlockX(configuration,inputTextArea) {
  this.textArea = inputTextArea;
  this.validateConfiguration(configuration);
  this.initializeVariables();
  const that = this;
  this.addChangeListener(function (event) {
    that.textArea.value = event.value;
})
...
function BlockXTextEditor(BlockX) {
  ...
  this.updateWidth();
  this.textContainer.style.height = BlockX.configuration.height; // Style sidebar
...
BlockXTextEditor.prototype.updateImages = function (cm, from, to) {
  ...
  cm.doc.eachLine(from, to, function (line) {
    var match;
    var regex = BlockXTextEditor.REGEX_PATTERNS[_this2.BlockX.configuration.imageDetection];
...
BlockXTextEditor.prototype.resizeResponsively = function () {
  var mode = this.BlockX.mode_;
  var configuration = this.VIEW_CONFIGURATIONS[mode];
  var width = configuration.width;
  var height = this.BlockX.configuration.height;
...
BlockXTextEditor.prototype.updateGutter = function (configuration) {
  if (configuration === undefined) {
    var mode = this.BlockX.mode_.toLowerCase();
    configuration = this.VIEW_CONFIGURATIONS[mode];
  }

  var isBigWindow = window.innerWidth >= this.BlockX.BREAK_WIDTH;

  if (configuration.indentSidebar && isBigWindow) {
    var gutterWidth = gutters.offsetWidth;
    var toolbarWidth = this.BlockX.blockEditor.getToolbarWidth();
...
BlockXTextEditor.prototype.getCode = function () {
};

BlockXTextEditor.prototype.changed = function (codeMirror, event) {
  var _this3 = this;
  ...
  if (!this.silentEvents_) {
    var handleChange = function handleChange() {
      ...
      _this3.BlockX.blockEditor.setCode(newCode, true);

      _this3.BlockX.setCode(newCode, true);
    };

    if (this.BlockX.configuration.blockDelay === false) {
      handleChange();
    } else {
      ...
      this.updateTimer_ = setTimeout(handleChange, this.BlockX.configuration.blockDelay);
    }
  }
...
BlockXTextEditor.prototype.isVisible = function () {
  return this.BlockX.VISIBLE_MODES.text.indexOf(this.BlockX.mode_) !== -1;
};
...
BlockXTextEditor.prototype.clearHighlightedLines = function () {
  var _this5 = this;
...
BlockX.prototype.validateConfiguration = function (configuration) {
  ...
  if ('blocklyMediaPath' in configuration) {
    ...
    this.configuration.blocklyMediaPath = '../node_modules/blockly/media';
  } // Run function
  ...
  this.configuration.toolbox = configuration.toolbox || "ct"; // 
...
function BlockXBlockEditor(BlockX) {
  ...
  this.blockArea = BlockX.tags.blockArea; // Null, or the source of the last update
  ...
  this.workspace = Blockly.inject(BlockX.tags.blockEditor, blocklyOptions); // Configure Blockly
...
BlockXBlockEditor.prototype.resizeReadOnlyDiv = function () {
  if (this.readOnlyDiv_ !== null) {
    ...
    var blockArea = this.BlockX.tags.blockArea;
...
BlockXBlockEditor.prototype.resized = function (e) {
  this.resizeResponsively(); // Compute the absolute coordinates and dimensions of blocklyArea.

  var blockArea = this.BlockX.tags.blockArea;

  var blockEditor = this.BlockX.tags.blockEditor;
...
BlockXBlockEditor.prototype.toolboxPythonToBlocks = function (toolboxPython) {
  var _this6 = this;
  ...
  return toolboxPython.map(function (category) {
    ...
    var colour = BlockXTextToBlocks.COLOR[category.colour];
...
BlockXBlockEditor.prototype.makeToolbox = function () {
  var toolbox = this.BlockX.configuration.toolbox; // Use palette if it exists, otherwise assume its a custom one.

  if (toolbox in this.TOOLBOXES) {
    toolbox = this.TOOLBOXES[toolbox];//调用了工具箱
  } 
  ...
  for (var name in BlockXBlockEditor.EXTRA_TOOLS) {
...
BlockXBlockEditor.prototype.resizeResponsively = function () {
  ...
  if (mode === 'split') {
    if (window.innerWidth >= this.BlockX.BREAK_WIDTH) {
      ...
      this.blockContainer.style.height = this.BlockX.configuration.height + "px";
      this.blockArea.style.height = this.BlockX.configuration.height + "px";
    } else {
      this.blockContainer.style.width = '100%';
      this.blockContainer.style.height = this.BlockX.configuration.height / 2 + "px";
      this.blockArea.style.height = this.BlockX.configuration.height / 2 + "px";
    }
  } else if (mode === 'block') {
    this.blockContainer.style.width = configuration.width;
    this.blockContainer.style.height = this.BlockX.configuration.height + "px";
...
BlockXBlockEditor.prototype.setCode = function (code, quietly) {
  if (this.isVisible()) {
   // var result = this.BlockX.textToBlocks.convertSource('__main__.py', code);
   let result = "";
    if (quietly) {
...
BlockXBlockEditor.prototype.BLOCKLY_CHANGE_EVENTS = [Blockly.Events.CREATE, Blockly.Events.DELETE, Blockly.Events.CHANGE, Blockly.Events.MOVE, Blockly.Events.VAR_RENAME];
...
BlockXBlockEditor.prototype.isVisible = function () {
  return this.BlockX.VISIBLE_MODES.block.indexOf(this.BlockX.mode_) !== -1;
};
...
BlockXBlockEditor.prototype.highlightLines = function (lines, style) {// Make some kind of block map?
};
...
BlockXTextToBlocks.prototype.convertSourceToCodeBlock = function (python_source) {
  var xml = document.createElement("xml");
  xml.appendChild(BlockXTextToBlocks.raw_block(python_source));
...
BlockXTextToBlocks.prototype.convertSource = function (filename, python_source) {
...
BlockXTextToBlocks.prototype.recursiveMeasure = function (node, nextBlockLine) {
  if (node === undefined) {
    return;
  }
...
BlockXTextToBlocks.prototype.TOP_LEVEL_NODES = ['Module', 'Expression', 'Interactive', 'Suite'];
...
BlockXTextToBlocks.prototype.convertStatement = function (node, full_source, parent) {
  try {
...
BlockXTextToBlocks.create_block = function (type, lineNumber, fields, values, settings, mutations, statements) {
...
BlockXTextToBlocks.prototype['ast_Expression'] = BlockXTextToBlocks.prototype['ast_Interactive'];
BlockXTextToBlocks.prototype['ast_Suite'] = BlockXTextToBlocks.prototype['ast_Module'];

BlockXTextToBlocks.prototype['ast_Pass'] = function () {
  return null; //block("controls_pass");
};

BlockXTextToBlocks.prototype.convertElements = function (key, values, parent) {
  var output = {};
...
BlockXTextToBlocks['ast_Image'] = function (node, parent, bmttb) {
  ...
  return BlockXTextToBlocks.create_block("ast_Image", node.lineno, {}, {}, {}, {
...
BlockXTextToBlocks.prototype.MODULE_FUNCTION_IMPORTS = {
  "plt": "import matplotlib.pyplot as plt",
  "turtle": "import turtle"
};
BlockXTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES = {
  "cisc108": {
    'assert_equal': {
      returns: false,
      simple: ["left", "right"],
  ...
  'plt': {
    'show': {
      ...
      colour: BlockXTextToBlocks.COLOR.PLOTTING
    },
    'hist': {
      returns: false,
      simple: ['values'],
...
BlockXTextToBlocks.prototype.FUNCTION_SIGNATURES['assert_equal'] = BlockXTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['cisc108']['assert_equal'];

function makeTurtleBlock(name, returns, values, message, aliases) {
  BlockXTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['turtle'][name] = {
    "returns": returns,
    "simple": values,
    "message": message,
    colour: BlockXTextToBlocks.COLOR.PLOTTING
  ...
  if (aliases) {
    aliases.forEach(function (alias) {
      BlockXTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['turtle'][alias] = BlockXTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['turtle'][name];
    });
  }
}
...
BlockXTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['matplotlib.pyplot'] = BlockXTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['plt'];
...
BlockXTextToBlocks.getFunctionBlock = function (name, values, module) {
  ...
  if (module !== undefined) {
    signature = BlockXTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES[module][name];
  } else if (name.startsWith('.')) {
    signature = BlockXTextToBlocks.prototype.METHOD_SIGNATURES[name.substr(1)];
    method = true;
  } else {
  ...
  var newBlock = BlockXTextToBlocks.create_block("ast_Call", null, {}, values, {
    inline: true
...
var ZERO_BLOCK = BlockXTextToBlocks.create_block('ast_Num', null, {
  'NUM': 0
});
...
BlockXBlockEditor.prototype.TOOLBOXES = {
  ...
  'normal': [TOOLBOX_CATEGORY.VARIABLES, TOOLBOX_CATEGORY.DECISIONS, {
    name: "Iteration",
    colour: "CONTROL",
    blocks: ['for a in b: pass', 'while ___: pass', 'break']
  }, {
    name: "Functions",
    colour: "FUNCTIONS",
...
BlockXTextToBlocks.BLOCKS.push({
  "type": "ast_For",
  "message0": "for each item %1 in list %2 : %3",
  "args0": [{
    "type": "input_value",
    "name": "TARGET"
  }, {
...
BlockXTextToBlocks.prototype['ast_For'] = function (node, parent) {
...
BlockXTextToBlocks.prototype['ast_ForElse'] = BlockXTextToBlocks.prototype['ast_For'];
...
BlockXTextToBlocks.prototype['ast_If'] = function (node, parent) {
  var test = node.test;
  var body = node.body;
  var orelse = node.orelse;
  var hasOrelse = false;
  ...
  return BlockXTextToBlocks.create_block("ast_If", node.lineno, {}, values, {}, {
    "@orelse": hasOrelse,
    "@elifs": elifCount
  }, statements);
};
...
BlockXTextToBlocks.prototype['ast_While'] = function (node, parent) {
  var test = node.test;
  var body = node.body;
  var orelse = node.orelse;
  var values = {
  ...
  return BlockXTextToBlocks.create_block("ast_While", node.lineno, {}, values, {}, {
    "@orelse": hasOrelse
  }, statements);
};
...
BlockXTextToBlocks.prototype['ast_Num'] = function (node, parent) {
  var n = node.n;
...
BlockXTextToBlocks.BINOPS_AUGASSIGN_DISPLAY_FULL = BlockXTextToBlocks.BINOPS.map(function (binop) {
  return [binop[4], binop[1]];
});
BlockXTextToBlocks.BINOPS_AUGASSIGN_DISPLAY = BlockXTextToBlocks.BINOPS_AUGASSIGN_DISPLAY_FULL.filter(function (binop) {
  return BINOPS_SIMPLE.indexOf(binop[1]) >= 0;
});
...
BlockXTextToBlocks.BINOPS.forEach(function (binop) {
  ...
  BlockXTextToBlocks.BINOPS_AUGASSIGN_PREPOSITION[binop[1]] = binop[5]; //Blockly.Constants.Math.TOOLTIPS_BY_OP[binop[1]] = binop[3];
});
BlockXTextToBlocks.BLOCKS.push({
  "type": "ast_BinOpFull",
  "message0": "%1 %2 %3",
  ...
  "inputsInline": true,
  "output": null,
  "colour": BlockXTextToBlocks.COLOR.MATH //"extensions": ["math_op_tooltip"]
...
BlockXTextToBlocks.prototype['ast_BinOp'] = function (node, parent) {
  var left = node.left;
  var op = node.op.name;
...
BlockXTextToBlocks.prototype['ast_BinOpFull'] = BlockXTextToBlocks.prototype['ast_BinOp'];
BlockXTextToBlocks.BLOCKS.push({
  "type": "ast_Name",
  "message0": "%1",
  "args0": [{
...
Blockly.Extensions.registerMixin('contextMenu_variableSetterGetter_forBlockX', Blockly.Constants.Variables.CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN_FOR_BLOCK_MIRROR);
...
BlockXTextToBlocks.prototype['ast_Name'] = function (node, parent) {
  var id = node.id;
  var ctx = node.ctx;
...
BlockXTextToBlocks.prototype['ast_Assign'] = function (node, parent) {
  ...
  return BlockXTextToBlocks.create_block("ast_Assign", node.lineno, fields, values, {
    "inline": "true"
  }, {
...
BlockXTextToBlocks.ANNOTATION_OPTIONS = [["int", "int"], ["float", "float"], ["str", "str"], ["bool", "bool"], ["None", "None"]];
...
Blockly.Blocks['ast_AnnAssign'] = {
  init: function init() {
    this.appendDummyInput().appendField("set").appendField(new Blockly.FieldVariable("item"), "TARGET").appendField(":").appendField(new Blockly.FieldDropdown(BlockXTextToBlocks.ANNOTATION_OPTIONS), "ANNOTATION");
...
BlockXTextToBlocks.prototype['ast_AnnAssign'] = function (node, parent) {
  var target = node.target;
  ...
  if (target._astname === 'Name' && target.id.v !== Blockly.Python.blank && builtinAnnotation !== false) {
    ...
    return BlockXTextToBlocks.create_block("ast_AnnAssignFull", node.lineno, {}, values, {
      "inline": "true"
    }, mutations);
  }
};
...
Blockly.Blocks['ast_AugAssign'] = {
  init: function init() {
    ...
    this.appendDummyInput("OP").appendField(new Blockly.FieldDropdown(function () {
      return block.allOptions_ ? BlockXTextToBlocks.BINOPS_AUGASSIGN_DISPLAY_FULL : BlockXTextToBlocks.BINOPS_AUGASSIGN_DISPLAY;
    }, function (value) {
  ...
  updatePreposition_: function updatePreposition_(value) {
    var preposition = BlockXTextToBlocks.BINOPS_AUGASSIGN_PREPOSITION[value];
...
BlockXTextToBlocks.prototype['ast_AugAssign'] = function (node, parent) {
  var target = node.target;
  var op = node.op.name;
  var value = node.value;
  var values = {
  ...
  return BlockXTextToBlocks.create_block("ast_AugAssign", node.lineno, fields, values, {
    "inline": "true"
  }, {
    "@options": allOptions,
    "@simple": simpleTarget,
...
BlockXTextToBlocks.prototype['ast_Str'] = function (node, parent) {
  ...
  var regex = BlockXTextEditor.REGEX_PATTERNS[this.BlockX.configuration.imageDetection]; //console.log(text, regex.test(JSON.stringify(text)));
  ...
  if (regex.test(JSON.stringify(text))) {
    ...
    return [BlockXTextToBlocks.create_block("ast_StrDocstring", node.lineno, {
      "TEXT": dedented
    })];
    ...
    return BlockXTextToBlocks.create_block("ast_StrMultiline", node.lineno, {
      "TEXT": _dedented
    });
  }
};
...
BlockXTextToBlocks.UNARYOPS = [["+", "UAdd", 'Do nothing to the number'], ["-", "USub", 'Make the number negative'], ["not", "Not", 'Return the logical opposite of the value.'], ["~", "Invert", 'Take the bit inversion of the number']];
BlockXTextToBlocks.UNARYOPS.forEach(function (unaryop) {
  ...
  BlockXTextToBlocks.BLOCKS.push({
    ...
    "inputsInline": false,
    "output": null,
    "colour": unaryop[1] === 'Not' ? BlockXTextToBlocks.COLOR.LOGIC : BlockXTextToBlocks.COLOR.MATH
  });
...
BlockXTextToBlocks.prototype['ast_UnaryOp'] = function (node, parent) {
  var op = node.op.name;
  var operand = node.operand;
  return BlockXTextToBlocks.create_block('ast_UnaryOp' + op, node.lineno, {}, {
...
BlockXTextToBlocks.BOOLOPS = [["and", "And", Blockly.Python.ORDER_LOGICAL_AND, 'Return whether the left and right both evaluate to True.'], ["or", "Or", Blockly.Python.ORDER_LOGICAL_OR, 'Return whether either the left or right evaluate to True.']];
var BOOLOPS_BLOCKLY_DISPLAY = BlockXTextToBlocks.BOOLOPS.map(function (boolop) {
...
BlockXTextToBlocks.prototype['ast_BoolOp'] = function (node, parent) {
  var op = node.op;
  var values = node.values;
  var result_block = this.convert(values[0], node);

  for (var i = 1; i < values.length; i += 1) {
    result_block = BlockXTextToBlocks.create_block("ast_BoolOp", node.lineno, {
      "OP": op.name
    }, {
      "A": result_block,
...
BlockXTextToBlocks.COMPARES = [["==", "Eq", 'Return whether the two values are equal.'], ["!=", "NotEq", 'Return whether the two values are not equal.'], ["<", "Lt", 'Return whether the left value is less than the right value.'], ["<=", "LtE", 'Return whether the left value is less than or equal to the right value.'], [">", "Gt", 'Return whether the left value is greater than the right value.'], [">=", "GtE", 'Return whether the left value is greater than or equal to the right value.'], ["is", "Is", 'Return whether the left value is identical to the right value.'], ["is not", "IsNot", 'Return whether the left value is not identical to the right value.'], ["in", "In", 'Return whether the left value is in the right value.'], ["not in", "NotIn", 'Return whether the left value is not in the right value.']];
var COMPARES_BLOCKLY_DISPLAY = BlockXTextToBlocks.COMPARES.map(function (boolop) {
  return [boolop[0], boolop[1]];
});
...
BlockXTextToBlocks.prototype['ast_Compare'] = function (node, parent) {
  var ops = node.ops;
  var left = node.left;
  ...
  for (var i = 0; i < values.length; i += 1) {
    result_block = BlockXTextToBlocks.create_block("ast_Compare", node.lineno, {
      "OP": ops[i].name
    }, {
      "A": result_block,
      "B": this.convert(values[i], node)
...
BlockXTextToBlocks.prototype['ast_Assert'] = function (node, parent) {
  var test = node.test;
  var msg = node.msg;
  ...
  if (msg == null) {
    ...
    return BlockXTextToBlocks.create_block("ast_AssertFull", node.lineno, {}, {
      "TEST": this.convert(test, node),
...
BlockXTextToBlocks.prototype['ast_NameConstant'] = function (node, parent) {
  var value = node.value;

  if (value === Sk.builtin.none.none$) {
    return BlockXTextToBlocks.create_block('ast_NameConstantNone', node.lineno, {});
  } else if (value === Sk.builtin.bool.true$) {
    return BlockXTextToBlocks.create_block('ast_NameConstantBoolean', node.lineno, {
      "BOOL": 'TRUE'
    });
...
BlockXTextToBlocks.prototype['ast_List'] = function (node, parent) {
  var elts = node.elts;
  var ctx = node.ctx;
  return BlockXTextToBlocks.create_block("ast_List", node.lineno, {}, this.convertElements("ADD", elts, node), {
...
BlockXTextToBlocks.prototype['ast_Tuple'] = function (node, parent) {
  var elts = node.elts;
  var ctx = node.ctx;
  return BlockXTextToBlocks.create_block("ast_Tuple", node.lineno, {}, this.convertElements("ADD", elts, node), {
...
BlockXTextToBlocks.prototype['ast_Set'] = function (node, parent) {
  var elts = node.elts;
  return BlockXTextToBlocks.create_block("ast_Set", node.lineno, {}, this.convertElements("ADD", elts, node), {
    "inline": elts.length > 3 ? "false" : "true"
  }, {
    "@items": elts.length
  });
...
BlockXTextToBlocks.prototype['ast_Dict'] = function (node, parent) {
  var keys = node.keys;
  var values = node.values;

  if (keys === null) {
    return BlockXTextToBlocks.create_block("ast_Dict", node.lineno, {}, {}, {
      "inline": "false"
    }, {
      "@items": 0
    });
  ...
  for (var i = 0; i < keys.length; i++) {
    var key = keys[i];
    var value = values[i];
    elements["ADD" + i] = BlockXTextToBlocks.create_block("ast_DictItem", node.lineno, {}, {
      "KEY": this.convert(key, node),
      "VALUE": this.convert(value, node)
    }, this.LOCKED_BLOCK);
  }

  return BlockXTextToBlocks.create_block("ast_Dict", node.lineno, {}, elements, {
    "inline": "false"
  }, {
    "@items": keys.length
  });
...
BlockXTextToBlocks.prototype['ast_Starred'] = function (node, parent) {
  var value = node.value;
  var ctx = node.ctx;
...
BlockXTextToBlocks.prototype['ast_IfExp'] = function (node, parent) {
  var test = node.test;
  var body = node.body;
  var orelse = node.orelse;
...
BlockXTextToBlocks.prototype['ast_Attribute'] = function (node, parent) {
  var value = node.value;
  ...
  if (value._astname == "Name") {
    ...
    return BlockXTextToBlocks.create_block("ast_AttributeFull", node.lineno, {
      "ATTR": Sk.ffi.remapToJs(attr)
    }, {
      "VALUE": this.convert(value, node)
    });
...
Blockly.Python['ast_Call'] = function (block) {
  // TODO: Handle import
  if (block.module_) {
    Blockly.Python.definitions_["import_" + block.module_] = BlockXTextToBlocks.prototype.MODULE_FUNCTION_IMPORTS[block.module_];
...
BlockXTextToBlocks.prototype['ast_Call'] = function (node, parent) {
  ...
  var name = "";
  var caller = null;
  var colour = BlockXTextToBlocks.COLOR.FUNCTIONS;
  ...
  if (isMethod) {
    ...
    newBlock = BlockXTextToBlocks.create_block("ast_Call", node.lineno, {}, argumentsNormal, {
      inline: true
    }, argumentsMutation);
  } else {
    newBlock = BlockXTextToBlocks.create_block("ast_Call", node.lineno, {}, argumentsNormal, {
...
BlockXTextToBlocks.prototype['ast_Raise'] = function (node, parent) {
  var exc = node.exc;
  ...
  return BlockXTextToBlocks.create_block("ast_Raise", node.lineno, {}, values, {}, {
    '@exc': hasExc,
    '@cause': hasCause
  });
};
...
BlockXTextToBlocks.prototype['ast_Delete'] = function (node, parent) {
  var targets = node.targets;
  return BlockXTextToBlocks.create_block("ast_Delete", node.lineno, {}, this.convertElements("TARGET", targets, node), {
    "inline": "true"
  }, {
    "@targets": targets.length
  });
...
BlockXTextToBlocks.prototype.addSliceDim = function (slice, i, values, mutations, node) {
...
BlockXTextToBlocks.prototype['ast_Subscript'] = function (node, parent) {
  var value = node.value;
  ...
  return BlockXTextToBlocks.create_block("ast_Subscript", node.lineno, {}, values, {
    "inline": "true"
  }, {
    "arg": mutations
  });
...
['ListComp', 'SetComp', 'GeneratorExp', 'DictComp'].forEach(function (kind) {
  Blockly.Blocks['ast_' + kind] = {
    ...
    init: function init() {
      ...
      this.itemCount_ = 3;
      var input = this.appendValueInput("ELT").appendField(BlockXTextToBlocks.COMP_SETTINGS[kind].start);

      if (kind === 'DictComp') {
        input.setCheck('DictPair');
      }

      this.appendDummyInput("END_BRACKET").appendField(BlockXTextToBlocks.COMP_SETTINGS[kind].end);
      this.updateShape_();
      this.setOutput(true);
  ...
  Blockly.Python['ast_' + kind] = function (block) {
    ...
    var code = BlockXTextToBlocks.COMP_SETTINGS[kind].start + elt + " " + elements.join(' ') + BlockXTextToBlocks.COMP_SETTINGS[kind].end;
    return [code, Blockly.Python.ORDER_ATOMIC];
  };

  BlockXTextToBlocks.prototype['ast_' + kind] = function (node, parent) {
    ...
    if (kind === 'DictComp') {
      var key = node.key;
      var value = node.value;
      elements["ELT"] = BlockXTextToBlocks.create_block("ast_DictItem", node.lineno, {}, {
        "KEY": this.convert(key, node),
        "VALUE": this.convert(value, node)
      }, {
        "inline": "true",
    ...
    for (var i = 0; i < generators.length; i++) {
      ...
      elements["GENERATOR" + g] = BlockXTextToBlocks.create_block("ast_comprehensionFor", node.lineno, {}, {
        "ITER": this.convert(iter, node),
        "TARGET": this.convert(target, node)
      }, DEFAULT_SETTINGS);
      g += 1;
      ...
      if (ifs) {
        for (var j = 0; j < ifs.length; j++) {
          elements["GENERATOR" + g] = BlockXTextToBlocks.create_block("ast_comprehensionIf", node.lineno, {}, {
    ...
    return BlockXTextToBlocks.create_block("ast_" + kind, node.lineno, {}, elements, {
      "inline": "false"
    }, {
      "@items": g
    });
...
BlockXTextToBlocks.prototype.parseArg = function (arg, type, lineno, values, node) {
  var settings = {
    "movable": false,
    "deletable": false
  };
...
BlockXTextToBlocks.prototype.parseArgs = function (args, values, lineno, node) {
...
BlockXTextToBlocks.prototype['ast_FunctionDef'] = function (node, parent) {
  var name = node.name;
  var args = node.args;
  var body = node.body;
...
BlockXTextToBlocks.prototype['ast_Lambda'] = function (node, parent) {
  var args = node.args;
  var body = node.body;
  var values = {
    'BODY': this.convert(body, node)
  ...
  return BlockXTextToBlocks.create_block("ast_Lambda", node.lineno, {}, values, {
    "inline": "false"
  }, {
    "@decorators": 0,
    "@parameters": parsedArgs,
...
BlockXTextToBlocks.prototype['ast_Return'] = function (node, parent) {
  var value = node.value;

  if (value == null) {
    return BlockXTextToBlocks.create_block("ast_Return", node.lineno);
  } else {
    return BlockXTextToBlocks.create_block("ast_ReturnFull", node.lineno, {}, {
      "VALUE": this.convert(value, node)
    });
  }
};
...
BlockXTextToBlocks.prototype['ast_Yield'] = function (node, parent) {
  var value = node.value;
...
BlockXTextToBlocks.prototype['ast_YieldFrom'] = function (node, parent) {
  var value = node.value;
  return BlockXTextToBlocks.create_block("ast_YieldFrom", node.lineno, {}, {
    "VALUE": this.convert(value, node)
  });
};
...
BlockXTextToBlocks.prototype['ast_Global'] = function (node, parent) {
  ...
  return BlockXTextToBlocks.create_block("ast_Global", node.lineno, fields, {}, {
    "inline": "true"
  }, {
    "@names": names.length
  });
...
BlockXTextToBlocks.prototype['ast_Break'] = function (node, parent) {
  return BlockXTextToBlocks.create_block("ast_MyBreak", node.lineno);
};
...
BlockXTextToBlocks.prototype['ast_Continue'] = function (node, parent) {
...
BlockXTextToBlocks.prototype['ast_Try'] = function (node, parent) {
  var body = node.body;
  ...
  return BlockXTextToBlocks.create_block("ast_Try", node.lineno, fields, values, {}, mutations, statements);
};
...
BlockXTextToBlocks.prototype['ast_ClassDef'] = function (node, parent) {
  var name = node.name;
  ...
  return BlockXTextToBlocks.create_block("ast_ClassDef", node.lineno, fields, values, {
    "inline": "false"
  }, {
    "@decorators": decorator_list === null ? 0 : decorator_list.length,
...
BlockXTextToBlocks.prototype['ast_Import'] = function (node, parent) {
  var names = node.names;
  var fields = {};
  var mutations = {
    '@names': names.length
  ...
  return BlockXTextToBlocks.create_block("ast_Import", node.lineno, fields, {}, {
    "inline": true
  }, mutations);
}; // Alias ImportFrom because of big overlap


BlockXTextToBlocks.prototype['ast_ImportFrom'] = BlockXTextToBlocks.prototype['ast_Import'];
BlockXTextToBlocks.BLOCKS.push({
  "type": "ast_WithItem",
  "output": "WithItem",
  "message0": "context %1",
...
BlockXTextToBlocks.prototype['ast_With'] = function (node, parent) {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    if (hasRename) {
      ...
      values['ITEM' + i] = BlockXTextToBlocks.create_block("ast_WithItemAs", node.lineno, {}, innerValues, this.LOCKED_BLOCK);
    } else {
      values['ITEM' + i] = BlockXTextToBlocks.create_block("ast_WithItem", node.lineno, {}, innerValues, this.LOCKED_BLOCK);
    }
  }

  mutations['as'] = renamedItems;
  return BlockXTextToBlocks.create_block("ast_With", node.lineno, {}, values, {
    "inline": "false"
  }, mutations, {
    'BODY': this.convertBody(body, node)
  });
...
Blockly.Python['ast_MyBreak'] = function (block) {
  return "Mybreak\n";
};

BlockXTextToBlocks.prototype['ast_MyBreak'] = function (node, parent) {
  return BlockXTextToBlocks.create_block("ast_MyBreak", node.lineno);
};